# src: https://github.com/google-research/federated/blob/780767fdf68f2f11814d41bbbfe708274eb6d8b3/utils/datasets/emnist_dataset.py
...
def create_preprocess_fn(
	...
	max_elements_per_client: int = 10000,
) -> tff.Computation:
	...
	def preprocess_fn(dataset):
		return dataset.take(max_elements_per_client).shuffle(shuffle_buffer_size).repeat(num_epochs).batch(
...
def get_federated_datasets(
	...
	emnist_train, emnist_test = tff.simulation.datasets.emnist.load_data(
		only_digits=only_digits, cache_dir='./datasets')
