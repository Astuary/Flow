...
# src: https://github.com/google-research/federated/blob/780767fdf68f2f11814d41bbbfe708274eb6d8b3/utils/datasets/shakespeare_dataset.py
...
def create_preprocess_fn(
    ...
    def preprocess_fn(dataset):
        ...
        return (
            ...
            .shuffle(shuffle_buffer_size).repeat(num_epochs)
...
def get_federated_datasets(
    ...
    shakespeare_train, shakespeare_test = (
        tff.simulation.datasets.shakespeare.load_data(cache_dir='./datasets'))
