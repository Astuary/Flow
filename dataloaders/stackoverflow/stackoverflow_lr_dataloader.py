...
# src: https://github.com/google-research/federated/blob/780767fdf68f2f11814d41bbbfe708274eb6d8b3/utils/datasets/stackoverflow_tag_prediction.py
...
def get_federated_datasets(
  ...
  (stackoverflow_train, _,
   stackoverflow_test) = tff.simulation.datasets.stackoverflow.load_data(cache_dir='./datasets')
